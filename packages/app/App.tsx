/**
 * App.tsx — v2 entry (Phase 4).
 *
 * Responsibilities (kept narrow on purpose):
 *  1. crypto-init once at boot
 *  2. load PhoneState from SecureStore
 *  3. branch: not-booted → LoadingScreen | not-paired → LoginScreen | else → MainScreen
 *
 ...
 *
 * Importing from:
 *  - ./src/crypto-init (stable, see REUSE.md)
 *  - ./src/store (PhoneState persistence)
 *  - ./src/app/{loading,login,main}-screen (new placeholders)
 */
